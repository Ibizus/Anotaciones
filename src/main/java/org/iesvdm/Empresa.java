...
// La razón por la que podemos repetir la anotación de Empleado es porque la hemos marcado como @Repeteable
...
// Voy a intentar meter un Empleado repetido para evaluar el resultado:
// (Así comprobamos que la lógica de las clases está correctamente creada)
@EmpleadoAnot(nombre = "Mireya", apellidos = "Medalle", dni = "66666666F", direccion = "Las Lagunas", telefono = "655555555", clase = "Oficial", categoria = "segunda")
